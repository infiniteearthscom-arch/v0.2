  ...
  return (
    <div className="fixed top-3 left-3 flex items-center gap-3 z-40">
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-900/80 border border-yellow-500/20 backdrop-blur-sm">
        ...
        <span className="text-[0.8rem] text-yellow-600">cr</span>
      </div>
      ...
      {activeShip && (
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-900/80 border border-cyan-500/20 backdrop-blur-sm">
          ...
          {activeShip.hull_name && (
            <span className="text-[0.8rem] text-slate-500">({activeShip.hull_name})</span>
          )}
        </div>
      )}
      ...
      <button
        onClick={handleReset}
        disabled={resetting}
        className="px-2 py-1 rounded text-[0.8rem] font-medium bg-red-900/40 border border-red-700/40 text-red-400 hover:bg-red-900/70 hover:text-red-300 disabled:opacity-40 disabled:cursor-not-allowed"
