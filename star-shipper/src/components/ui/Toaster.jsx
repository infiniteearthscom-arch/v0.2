...
const ToastCard = ({ toast, onDismiss }) => {
  ...
  // Font sizes are in rem — the root font-size hook in App.jsx applies
  // the Settings UI-font-scale to all rem text. (This card used to
  // multiply by uiScale itself, from before the codebase-wide rem
  // convention; that would now double-scale.)
