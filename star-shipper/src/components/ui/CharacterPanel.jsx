...
const TeaserRow = ({ icon, label, detail }) => (
  <div style={{
    ...
    <div style={{ flex: 1, minWidth: 0 }}>
      ...
      {detail && <div style={{ fontSize: '0.8rem', color: '#3a5a6a', fontFamily: FM }}>{detail}</div>}
    </div>
    <span style={{
      fontSize: '0.5rem',
      color: '#4a6080',
      ...
      {trainingProgress && trainingSkill && (
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: '0.8rem', color: BLUE.light, fontWeight: 700, letterSpacing: 0.5, fontFamily: F, textTransform: 'uppercase' }}>
              Training
            </span>
            <span style={{ fontSize: '0.8rem', color: '#3a5a6a', fontFamily: FM }}>
