...
const CraftingCargoPanel = ({ isOpen, selectedRecipe, onAssign }) => {
  ...
  // so crossing tiles doesn't re-render the whole pane (the tooltip
  // lag bug). Same pattern as InventoryWindow.
  ...
  const handleHoverLeave = () => cargoTooltip.hide();
  // Don't let a tooltip outlive the panel (mouseleave doesn't fire on
  // unmounted tiles).
  ...
  return (
    ...
    >
      ...
      {/* Hover tooltip renders via the singleton CargoTooltipLayer
          mounted in GameFrame (see CargoTooltipLayer.jsx). */}
    </div>
  );
};
            ...
            CATEGORY_ORDER.map(cat => {
              ...
              return (
                <div key={cat} style={{ marginBottom: 4 }}>
                  ...
                  >
                    <span style={{ fontSize: '0.8rem', color: COLORS.TEXT.dim, width: 10 }}>{isCollapsed ? '▸' : '▾'}</span>
                      ...
                      {MODULE_SUBCAT_ORDER.map(sub => {
                        ...
                        return (
                          <div key={sub} style={{ marginBottom: 2 }}>
                            ...
                            >
                              <span style={{ fontSize: '0.5rem', color: COLORS.TEXT.dim, width: 8 }}>{isSubCollapsed ? '▸' : '▾'}</span>
                              <span style={{
                                width: 6,
                                height: 6,
              ...
              {(() => {
                ...
                return (
                  <div style={{
                    ...
                    <div style={{
                      fontSize: '0.8rem', color: '#fbbf24', fontFamily: FONT.ui,
                      fontWeight: 800, letterSpacing: 1, textTransform: 'uppercase',
                      marginBottom: 4,
                    }}>🔒 Research Required</div>
                    <div style={{ fontSize: '0.6875rem', color: '#e2e8f0', fontFamily: FONT.ui, marginBottom: 8 }}>
