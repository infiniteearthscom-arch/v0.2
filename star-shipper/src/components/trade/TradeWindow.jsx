...
const StackTile = ({ stack, count, onClick, dim, removable, onRemove, label }) => {
  ...
  return (
    ...
    >
      <span style={{ fontSize: '0.8rem', fontFamily: FM, color: '#cbd5e1', fontWeight: 700 }}>
        {RESOURCE_ICON(name)}
      </span>
      <span style={{
        position: 'absolute',
        bottom: 1, right: 2,
        fontSize: '0.8rem', fontFamily: FM, color: GOLD.light, fontWeight: 700,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {offerRows.length === 0 && (
          <div style={{
            fontSize: '0.8rem', color: '#475569', fontFamily: F, fontStyle: 'italic',
            padding: '20px 4px',
          }}>
            ...
            <div key={row.stack_id} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
              ...
              {!isOther && stack && stack.quantity > 1 && (
                <input
                  ...
                  style={{
                    width: 44, fontSize: '0.8rem', fontFamily: FM,
      ...
      <div style={{
        ...
        <span style={{ fontSize: '0.8rem', color: '#475569', fontFamily: FM, marginRight: 4 }}>CR</span>
        {isOther ? (
          ...
          {pickerOpen && (
            <div style={{
              ...
              {cargoStacks.length === 0 && (
                <div style={{ fontSize: '0.8rem', color: '#475569', fontFamily: F, fontStyle: 'italic', padding: 8 }}>
                  Your cargo is empty.
                </div>
              )}
              {cargoStacks.map(s => {
