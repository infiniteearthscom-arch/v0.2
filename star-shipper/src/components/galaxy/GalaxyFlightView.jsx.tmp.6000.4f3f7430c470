          ...
          {hoveredSystem && (
            <div className="absolute top-3 right-3 pointer-events-none">
              <div className="px-3 py-2 rounded-lg bg-slate-900/90 border border-slate-700/40 backdrop-blur-sm min-w-[160px]">
                ...
                <div className="text-[0.9rem] text-slate-500 mt-1">
                ...
                {hoveredSystem.regionName && (
                  <div className="text-[0.9rem]" style={{ color: tierColor(hoveredSystem.regionTier) }}>
                ...
                {hoveredSystem.hasJumpGate && (
                  <div className="text-[0.9rem] text-green-500 mt-0.5">Has Jump Gate</div>
                )}
                <div className="text-[0.9rem] text-slate-600 mt-0.5">
