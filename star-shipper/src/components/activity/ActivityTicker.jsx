  ...
  return (
    <>
      ...
      >
        ...
        <span style={{ color: '#475569', fontFamily: FM, fontSize: '0.8rem' }}>
  ...
  return (
    ...
    >
      <div style={{
        ...
        <span style={{ fontSize: '0.8rem', color: '#7a8a9a', letterSpacing: 1, textTransform: 'uppercase', fontWeight: 700 }}>
          Galaxy Activity
        </span>
        <button
          onClick={onClose}
      ...
      {recent.length === 0 ? (
        <div style={{ padding: 12, color: '#475569', fontSize: '0.8rem', fontStyle: 'italic', textAlign: 'center' }}>
          No activity yet.
        </div>
      ) : recent.map((evt) => {
