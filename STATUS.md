...
- DB schema: applied through migration **084** (085–088 authored 2026-09-25/26, pending deploy + migrate)  (deployed + migrated 2026-09-21; 009 was skipped). Always `npm run db:migrate` then `npm run db:verify` after a migration deploy — 064/065 and 068 each sat unapplied for weeks when that step was skipped.
